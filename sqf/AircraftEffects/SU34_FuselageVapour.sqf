...
_positions = [[-2,0.4,0],[-2.5,-1,0],[-1.5,-1.5,0],[2,0.4,0],[2.5,-1,0],[1.5,-1.5,0]];
_emitters = [];
...
while {true} do
	{
		...
		for "_i" from 0 to ((count _positions)-1) do {(_emitters select _i) setParticleParams ["\Ca\data\ParticleEffects\ROCKETSMOKE\RocketSmoke","","Billboard",1,0.1,(_positions select _i),(velocity _this),1,1.275,1,0.01,[1,3,10],[[1,1,1,0],[1,1,1,0.02*_opacity],[1,1,1,0.005*_opacity],[1,1,1,0]],[0],0.001,5,"","",_this]};
